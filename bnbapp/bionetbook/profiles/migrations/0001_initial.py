...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_favorite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ...
        db.send_create_signal('profiles', ['Favorite'])

        # Adding M2M table for field protocols on 'Favorite'
        db.create_table('profiles_favorite_protocols', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('favorite', models.ForeignKey(orm['profiles.favorite'], null=False)),
            ('protocol', models.ForeignKey(orm['protocols.protocol'], null=False))
        ))
        db.create_unique('profiles_favorite_protocols', ['favorite_id', 'protocol_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('profiles_favorite')

        # Removing M2M table for field protocols on 'Favorite'
        db.delete_table('profiles_favorite_protocols')
    ...
    models = {
        ...
        'profiles.favorite': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Favorite'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'note': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'protocols': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['protocols.Protocol']", 'symmetrical': 'False'}),
