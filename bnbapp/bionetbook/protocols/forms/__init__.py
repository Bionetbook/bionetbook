...
class ActionForm(NodeForm):
    ...
    min_time = forms.FloatField(required=False, help_text='this is the minimal time this should take')
...
class ComponentForm(NodeForm):
    ...
    ph = forms.FloatField(required=False, help_text='only if specified')
