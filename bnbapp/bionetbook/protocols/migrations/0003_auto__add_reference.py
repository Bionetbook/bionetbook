...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('protocols_reference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('typ', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal('protocols', ['Reference'])

        # Adding M2M table for field protocol on 'Reference'
        db.create_table('protocols_reference_protocol', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('reference', models.ForeignKey(orm['protocols.reference'], null=False)),
            ('protocol', models.ForeignKey(orm['protocols.protocol'], null=False))
        ))
        db.create_unique('protocols_reference_protocol', ['reference_id', 'protocol_id'])


    def backwards(self, orm):
        # Deleting model 'Reference'
        db.delete_table('protocols_reference')

        # Removing M2M table for field protocol on 'Reference'
        db.delete_table('protocols_reference_protocol')
    ...
    models = {
        ...
        'protocols.reference': {
            ...
            'typ': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        }
    }
