...
urlpatterns = patterns("",
    ...
    url(regex=r'^(?P<owner_slug>[-\w]+)/schedule/$', view=sviews.ScheduleListView.as_view(), name='schedule_protocol'),
    ...
    url(regex=r'^(?P<owner_slug>[-\w]+)/(?P<protocol_a_slug>[-\w]+)/$', view=cviews.LayoutSingleView.as_view(), name='protocol_detail'),
    ...
    # STEP URLS
    url(regex=r'^(?P<owner_slug>[-\w]+)/(?P<protocol_slug>[-\w]+)/step/add/$', view=views.StepCreateView.as_view(), name='step_create'),
    ...
    # ACTION URLS
    url(regex=r'^(?P<owner_slug>[-\w]+)/(?P<protocol_slug>[-\w]+)/(?P<step_slug>[-\w]+)/action/add/$', view=views.ActionVerbListView.as_view(), name='action_verb_list'),
    url(regex=r'^(?P<owner_slug>[-\w]+)/(?P<protocol_slug>[-\w]+)/(?P<step_slug>[-\w]+)/action/add/(?P<verb_slug>[-\w]+)/$', view=views.ActionCreateView.as_view(), name='action_create'),
    ...
    # THERMOCYCLER
    url(regex=r'^(?P<owner_slug>[-\w]+)/(?P<protocol_slug>[-\w]+)/(?P<step_slug>[-\w]+)/(?P<action_slug>[-\w]+)/themocycle/add/$', view=views.ThermocycleCreateView.as_view(), name='thermocycle_create'),
