...
class ProtocolSecurityTests(AutoBaseTest):
    ...
    FIRST USER CAN ACCESS THEIR PRIVATE DRAFT PROTOCOL

    FIRST USER CAN ACCESS THEIR PRIVATE PUBLISHED PROTOCOL

    FIRST USER CAN ACCESS THEIR PUBLIC DRAFT PROTOCOL

    FIRST USER CAN ACCESS THEIR PUBLIC PUBLISHED PROTOCOL
