...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('actions_action', (
            ...
            ('step', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['steps.Step'])),
            ...
            ('verb_attributes', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
    ...
    models = {
        'actions.action': {
            ...
            'step': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['steps.Step']"}),
            'verb': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'verb_attributes': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'})
        },
        'auth.group': {
