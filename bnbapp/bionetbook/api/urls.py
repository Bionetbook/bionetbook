...
urlpatterns = patterns("",
	...
	# url(regex=r'^json/aligned/(?P<protocol_a_slug>[-\w]+)/(?P<protocol_b_slug>[-\w]+)/$', view='api.views.get_layout_compare_json', name='protocols_aligned_json'),
	url(regex=r'^json/aligned/(?P<protocol_a_slug>[-\w]+)/$', view='api.views.get_protocol_layout_json', name='protocols_aligned_json'),
	...
	url(regex=r'^json/classbased/object_controller/(?P<protocol_a_slug>[-\w]+)/$', view=views.JsonObjectController3WayView.as_view(), name='JsonObjectControllerView'),
